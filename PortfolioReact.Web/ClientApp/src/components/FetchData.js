...
exports.FetchData = function () {
    var _a = React.useState([]), forecasts = _a[0], setForecasts = _a[1];
    var _b = React.useState(true), isLoading = _b[0], setIsLoading = _b[1];
    React.useEffect(function () {
        populateWeatherData();
    }, []);
    var renderForecastsTable = function (forecasts) {
        return (React.createElement("table", { className: 'table table-striped', "aria-labelledby": "tabelLabel" },
            ...
            React.createElement("tbody", null, forecasts.map(function (forecast, i) {
    ...
    var populateWeatherData = function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, data;
